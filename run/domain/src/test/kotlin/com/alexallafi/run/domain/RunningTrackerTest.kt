...
import com.alexallafi.core.test.LocationObserverFake
import com.alexallafi.core.test.MainCoroutineExtension
...
class RunningTrackerTest {
    ...
    fun testCombiningRunData() = runTest {
        ...
        runningTracker.runData.test {
            ...
            val location1 = LocationWithAltitude(
            ...
            val location2 = LocationWithAltitude(

...
import com.alexallafi.run.domain.LocationDataCalculator
...
class ActiveRunViewModel(
    ...
    private val shouldTrack = snapshotFlow { state.shouldTrack }.stateIn(viewModelScope, SharingStarted.Eagerly, state.shouldTrack)
